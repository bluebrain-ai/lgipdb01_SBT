...
return caPolicyNum + caPolicyCommon.toFixedWidthString() + caPolicySpecific + caEndowment.toFixedWidthString() + caHouse.toFixedWidthString() + caMotor.toFixedWidthString() + caCommercial.toFixedWidthString() + caClaim.toFixedWidthString();
}
