...
return caRequestId + caReturnCode + caCustomerNum + caRequestSpecific + caCustomerRequest.toFixedWidthString() + caCustsecrRequest.toFixedWidthString() + caPolicyRequest.toFixedWidthString();
}
