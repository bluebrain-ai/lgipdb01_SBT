...
public interface IgetCommercialDb2Info3CustCursorJpa extends JpaRepository<PolicyEntity, Integer> {
    ...
    Stream<IGetCommercialPolicy2JpaDto> getCustCursorByDb2CustomernumInt(
