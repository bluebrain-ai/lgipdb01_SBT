...
import com.bluescript.demo.dto.IgetCommercialDb2Info5CurZipCursorJpaDto;
import com.bluescript.demo.entity.undefinedEntity;

public interface IgetCommercialDb2Info5CurZipCursorJpa extends JPARepository<undefinedEntity, ID> {
    @QueryHints(value = {
    ...
    IgetCommercialDb2Info5CurZipCursorJpaDto getZipCursorByCaBPostcode(@Param("caBPostcode") String caBPostcode);
}
