...
public interface IGetPolicy3Jpa extends JpaRepository<PolicyEntity, ID> {
    ...
    IGetPolicy3JpaDto getPolicyByDb2CustomernumIntAndDb2PolicynumInt(@Param("db2CustomernumInt") int db2CustomernumInt,
