...
public interface IGetPolicy4Jpa extends JPARepository<PolicyEntity, ID> {
    @QueryHints(value = {
    ...
    IGetPolicy4JpaDto getPolicyByDb2PolicynumInt(@Param("db2PolicynumInt") int db2PolicynumInt);
}
