...
public interface IGetPolicy5Jpa extends JpaRepository<PolicyEntity, ID> {
    ...
    IGetPolicy5JpaDto getPolicyByDb2ClaimnumInt(@Param("db2ClaimnumInt") int db2ClaimnumInt);
}
